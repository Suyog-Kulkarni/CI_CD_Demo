 ...
 * 
 * @Test public static void WebDM() throws InterruptedException {
 * 
 * WebDriverManager.chromedriver().setup(); ChromeDriver driver = new
 * ChromeDriver(); driver.get("https://www.sugarcrm.com/au/request-demo/");
 * 
 ...
 * select.selectByVisibleText("51 - 100 employees"); select.selectByIndex(4); }
 * }
 */